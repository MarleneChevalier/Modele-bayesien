...
L'état des coefficients présente pour chaque coefficient de la régression :    
...
alpha6=30
z6=rpareto(n, m, alpha6)
dfz6=data.frame(
  z=z6,
  alpha=factor(alpha6)
)

dfz=rbind.data.frame(dfz1,dfz2,dfz3,dfz4,dfz5,dfz6)
...
Cependant, il semble qu'à partir d'une valeur seuil d'alpha (ici α=10), la densité perde en intensité et revienne à des niveaux déjà atteints par des valeurs d'alpha inférieures à ce seuil. Cette valeur seuil semble revenir périodiquement (ici on a observé le seuil pour α=10 et α=30).
