...
**2.1 Choix de modèle regression bayésien: GIBBS**
...
**2.2 Choix de modèle regression linéaire**  
...
La loi de pareto est generée pour une variable Z. 

Selon 5 valeurs de alpha
```{r pareto}
set.seed(789)
m=21
n=10
